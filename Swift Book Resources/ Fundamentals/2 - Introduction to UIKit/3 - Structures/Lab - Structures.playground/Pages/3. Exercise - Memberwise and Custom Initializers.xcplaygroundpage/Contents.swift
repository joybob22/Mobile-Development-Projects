...
print("Some place has a latitude of \(somePlace.latitude) and a longitude of \(somePlace.longitude)")
...
let favoriteBook = Book(title: "Atomic Habits", author: "James Clear", pages: 500, price: 19.99)
/*:
