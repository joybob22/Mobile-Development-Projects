 ...
 */
struct User {
    static var currentUser: User = User(userName: "Brayden Lemke", email: "yessir@gmail.com", age: 22)
...
print("Total Users: \(User.totalUsers)")
var myUser = User(userName: "Brayden Lemke", email: "yessir@gmail.com", age: 22)
print("Total Users: \(User.totalUsers)")
var myUser1 = User(userName: "Brayden Lemke", email: "yessir@gmail.com", age: 22)
var myUser2 = User(userName: "Brayden Lemke", email: "yessir@gmail.com", age: 22)
var myUser3 = User(userName: "Brayden Lemke", email: "yessir@gmail.com", age: 22)
print("Total Users: \(User.totalUsers)")
 ...
 */
User.logIn(user: User(userName: "new User", email: "new email", age: 65))
print(User.currentUser)
