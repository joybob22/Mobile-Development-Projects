 ...
 */
let walkingChallenges = ["Walk for at least one minute for every hour you are awake!", "Walk 3 miles a day"]
let runningChallenges = ["Run 1 mile today", "Run 3 times this week"]
...
var acceptedChallenges = ["Run 1 mile today"]
