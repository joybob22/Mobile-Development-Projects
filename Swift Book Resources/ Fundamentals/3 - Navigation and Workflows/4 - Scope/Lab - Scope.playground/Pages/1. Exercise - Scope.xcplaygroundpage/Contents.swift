...
//print("The value of foo is \(foo)")
//The line above will generate an error when it is not a comment because foo is not defined outisde of the for loop
...
//Its because x is defined outside of the for loop now.
...
greeting(greeting: nil, name: "Brayden")
greeting(greeting: "Well hello", name: "Brayden")
