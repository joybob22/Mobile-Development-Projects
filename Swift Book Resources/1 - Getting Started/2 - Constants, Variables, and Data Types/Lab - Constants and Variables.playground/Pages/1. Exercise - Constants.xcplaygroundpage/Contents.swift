...
print("The code on line 9 did not compile because constants are not meant to change. If we try to change them then the compiler yells at us and doesn't allow the code to run.")
