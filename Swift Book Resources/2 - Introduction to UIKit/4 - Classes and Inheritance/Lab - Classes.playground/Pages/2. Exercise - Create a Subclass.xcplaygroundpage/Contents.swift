...
print("falcon was a reference to Spaceship directly which does not have a weapon property. We could print the 'weapon' property on destroyer because it is a reference to Fighter which has the property of weapon")
